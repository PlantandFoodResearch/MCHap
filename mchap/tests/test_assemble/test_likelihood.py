...
def test_log_dirichlet_multinomial_pmf(dosage, dispersion, unique_haplotypes, probability):
...
@pytest.mark.parametrize("dosage,unique_haplotypes,inbreeding,probability", 
    [
        ...
        [[1,1,1,1], 16, 0.1, 0.00020224831321022713],  # with F = 0.1 and u_haps = 16 then dispesion = 0.5625
