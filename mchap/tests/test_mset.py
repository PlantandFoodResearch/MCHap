...
@pytest.mark.parametrize(
    "query_x,query_y,answer",
    [
        pytest.param(
            ["000", "000", "111", "001"], ["000", "000", "111", "001"], True, id="0"
        ),
        pytest.param(
            ["000", "000", "111", "001"], ["000", "111", "001", "000"], True, id="1"
        ),
        pytest.param(
            ["000", "000", "111", "001"], ["000", "111", "111", "001"], False, id="2"
        ),
        pytest.param(
            ["000", "000", "111", "001"], ["000", "000", "111", "011"], False, id="3"
        ),
    ],
)
...
def test_unique_counts():
    query = from_strings(["111", "000", "100", "000", "000", "100"])
